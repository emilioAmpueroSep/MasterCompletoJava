...
public class G_NumericSystemsEntryDialog {
    public static void main(String[] args) {
        ...
        String StrNumber = JOptionPane.showInputDialog(null,"Entry a integer number"); // window to input data and initialize the JOptionPane class
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"Error, You must entry a integer number!!!");
...
//            return;
        ...
        JOptionPane.showMessageDialog(null, message); // show the last result
    }
}
