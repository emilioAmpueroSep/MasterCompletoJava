...
public class C_PrimitivesFloats {
    ...
    // static float varOutMethod; // it has not value assinged, it will be 0.0 by default
    static float varOutMethod = 45.2F; // with value assinged
    
    public static void main(String[] args) {
//        the floatings doubles, are used for save more than a quantity of numbers because of use of comma or point.
...
//        both are the same exponential "e" equals 10 and is raised to the 4th, move the comma 3 spaces to the right
        ...
        float realFloat3 = 1.5e4F;//15000F; // we multiply 1.5 x 10 raised to 4 // multiplicamos 1.5 x 10 elevado a la 4
    ...
    // if it possitives, the comma is shifted to the right; if it negative is shifted to the left;
        ...
        System.out.println("value minimun of a float: = " + Float.MIN_VALUE + "\n");
        System.out.println("=======================================================\n");
        ...
        System.out.println("value minimun of a double: = " + Double.MIN_VALUE + "\n");
        System.out.println("=======================================================\n");
