...
- to compile with arguments must be: java A_Intro._K_CommandLine.ArgumentCommandLine Emilio Antonio "Pedro Raul" if it's a compound word.(if it's not using package:  java ArgumentCommandLine...)
- If I want to code special characters, I have to use: java A_Intro._K_CommandLine.ArgumentCommandLine lalo pepe -encoding tf8 or java -encoding tf8 A_Intro._K_CommandLine.ArgumentCommandLine lalo pepe
