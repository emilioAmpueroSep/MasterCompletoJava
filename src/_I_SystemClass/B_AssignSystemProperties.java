...
//        1. create a file called: config.properties with properties we want adding (src/_I_SystemClass/config.properties)

        try {
//          2. adding FileInputStream with the path where is located config.properties
            FileInputStream archivo = new FileInputStream("src/_I_SystemClass/config.properties");
...
//          System.err.println... if I have an error ex: src/_I_SystemClass/config2.properties"); it is gonna appear other way of error in console.
